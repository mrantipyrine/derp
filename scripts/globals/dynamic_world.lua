...
require('scripts/globals/dynamic_world/world_bosses')
...
xi.dynamicWorld.onZoneTick = function(zone)
    ...
    if xi.dynamicWorld.namedRares and xi.dynamicWorld.namedRares.bindAmbientListeners then
        xi.dynamicWorld.namedRares.bindAmbientListeners(zone)
    end
    ...
    if xi.dynamicWorld.worldBosses and xi.dynamicWorld.worldBosses.tick then
        xi.dynamicWorld.worldBosses.tick(zone)
    end
end
