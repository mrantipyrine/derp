...
REPLACE INTO `item_equipment` VALUES
    (26117, "mycelium_medal", 45, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
    --                                                                                   ^NECK slot
...
REPLACE INTO `item_equipment` VALUES
    (11638, "wanderers_token", 13, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11638,  8,   3),   -- STR +3
    (11638,  9,   3);   -- DEX +3
...
REPLACE INTO `item_equipment` VALUES
    (28439, "nomads_cord", 36, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28439,  8,   5),   -- STR +5
    (28439,  10,   5),   -- VIT +5
    (28439, 23,  10);   -- ATT +10
...
REPLACE INTO `item_equipment` VALUES
    (28610, "elites_resolve", 51, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28610,  2,  50),   -- HP +50
    (28610,  8,   8),   -- STR +8
    (28610, 23,  15),   -- ATT +15
...
REPLACE INTO `item_equipment` VALUES
    (11677, "apex_shard", 73, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11677,  2, 100),   -- HP +100
    (11677,  5,  50),   -- MP +50
    (11677,  8,  10),   -- STR +10
...
REPLACE INTO `item_equipment` VALUES
    (23438, "williams_woolcap", 14, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23438,  1,   3),   -- DEF +3
    (23438,  2,  15),   -- HP +15
    (23438, 14,   3);   -- CHR +3
...
REPLACE INTO `item_equipment` VALUES
    (23539, "williams_woolmitt", 11, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23539,  1,   2),   -- DEF +2
    (23539,  10,   3),   -- VIT +3
    (23539,  13,   3);   -- MND +3
...
REPLACE INTO `item_equipment` VALUES
    (26007, "baarbaras_collar", 24, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (26007,  2,  20),   -- HP +20
    (26007, 14,   5),   -- CHR +5
    (26007,  13,   3);   -- MND +3
...
REPLACE INTO `item_equipment` VALUES
    (28441, "baarbaras_ribbon", 21, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28441, 68,   5),   -- EVA +5
    (28441,  11,   4),   -- AGI +4
    (28441, 14,   4);   -- CHR +4
...
REPLACE INTO `item_equipment` VALUES
    (28611, "larrys_lucky_fleece", 13, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28611,  1,   8),   -- DEF +8
    (28611,  2,  30),   -- HP +30
    (28611, 68,   5);   -- EVA +5
...
REPLACE INTO `item_equipment` VALUES
    (26008, "larrys_lanyard", 26, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (26008,  8,   5),   -- STR +5
    (26008, 23,   8),   -- ATT +8
    (26008, 25,   5);   -- ACC +5
...
REPLACE INTO `item_equipment` VALUES
    (23529, "sharons_shears", 50, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23529,  1,  12),   -- DEF +12
    (23529,  9,   8),   -- DEX +8
    (23529, 25,  10),   -- ACC +10
...
REPLACE INTO `item_equipment` VALUES
    (28612, "sharons_silken_mantle", 16, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28612,  1,  10),   -- DEF +10
    (28612,  2,  40),   -- HP +40
    (28612,  5,  20),   -- MP +20
...
REPLACE INTO `item_equipment` VALUES
    (14645, "toms_lucky_foot", 66, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (14645,  11,   3),   -- AGI +3
    (14645, 68,   3);   -- EVA +3
...
REPLACE INTO `item_equipment` VALUES
    (23751, "toms_hop_boots", 6, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23751,  1,   2),   -- DEF +2
    (23751,  11,   4),   -- AGI +4
    (23751, 68,   3);   -- EVA +3
...
REPLACE INTO `item_equipment` VALUES
    (11640, "harveys_hop_ring", 57, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11640,  11,   5),   -- AGI +5
    (11640,  9,   3),   -- DEX +3
    (11640, 68,   5);   -- EVA +5
...
REPLACE INTO `item_equipment` VALUES
    (27526, "harveys_spring_earring", 27, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (27526,  11,   6),   -- AGI +6
    (27526, 384,   3);   -- Haste +3
...
REPLACE INTO `item_equipment` VALUES
    (23439, "benedicts_fur_cap", 39, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23439,  1,   8),   -- DEF +8
    (23439,  11,   6),   -- AGI +6
    (23439, 68,   8),   -- EVA +8
...
REPLACE INTO `item_equipment` VALUES
    (28442, "benedicts_burrow_belt", 38, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28442,  9,   6),   -- DEX +6
    (28442,  11,   6),   -- AGI +6
    (28442, 25,   8);   -- ACC +8
...
REPLACE INTO `item_equipment` VALUES
    (23752, "theodores_dash_greaves", 55, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23752,  1,  14),   -- DEF +14
    (23752,  11,  10),   -- AGI +10
    (23752, 68,  12),   -- EVA +12
...
REPLACE INTO `item_equipment` VALUES
    (27527, "theodores_panic_earring", 51, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (27527,  11,  10),   -- AGI +10
    (27527, 68,  15),   -- EVA +15
    (27527, 384,   4);   -- Haste +4
...
REPLACE INTO `item_equipment` VALUES
    (23530, "camerons_shell_shield", 7, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23530,  1,   5),   -- DEF +5
    (23530,  10,   4),   -- VIT +4
    (23530,  2,  20);   -- HP +20
...
REPLACE INTO `item_equipment` VALUES
    (28529, "camerons_coral_ring", 9, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28529,  10,   5),   -- VIT +5
    (28529,  1,   4),   -- DEF +4
    (28529, 29,   4);   -- MDEF +4
...
REPLACE INTO `item_equipment` VALUES
    (23531, "ollies_brine_gauntlets", 30, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23531,  1,  10),   -- DEF +10
    (23531,  10,   7),   -- VIT +7
    (23531,  2,  30),   -- HP +30
...
REPLACE INTO `item_equipment` VALUES
    (28443, "ollies_seasoned_belt", 22, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28443,  10,   8),   -- VIT +8
    (28443,  1,   8),   -- DEF +8
    (28443, 29,   6);   -- MDEF +6
...
REPLACE INTO `item_equipment` VALUES
    (25692, "bernards_tidal_mail", 57, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25692,  1,  18),   -- DEF +18
    (25692,  10,  10),   -- VIT +10
    (25692,  2,  50),   -- HP +50
...
REPLACE INTO `item_equipment` VALUES
    (27528, "bernards_brine_earring", 38, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (27528,  10,   8),   -- VIT +8
    (27528, 29,  10),   -- MDEF +10
    (27528,  5,  20);   -- MP +20
...
REPLACE INTO `item_equipment` VALUES
    (23440, "duncans_abyssal_helm", 59, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23440,  1,  22),   -- DEF +22
    (23440,  10,  12),   -- VIT +12
    (23440,  2,  60),   -- HP +60
...
REPLACE INTO `item_equipment` VALUES
    (28567, "duncans_deepwater_ring", 74, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28567,  10,  12),   -- VIT +12
    (28567,  1,  15),   -- DEF +15
    (28567,  2,  80),   -- HP +80
...
REPLACE INTO `item_equipment` VALUES
    (23441, "chanterelles_spore_hat", 16, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23441,  1,   7),   -- DEF +7
    (23441,  12,   5),   -- INT +5
    (23441,  5,  20),   -- MP +20
...
REPLACE INTO `item_equipment` VALUES
    (28445, "chanterelles_mycelia", 21, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28445,  12,   6),   -- INT +6
    (28445,  13,   4),   -- MND +4
    (28445, 28,   5);   -- MATK +5
...
REPLACE INTO `item_equipment` VALUES
    (25693, "petes_fungal_robe", 46, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25693,  1,  15),   -- DEF +15
    (25693,  12,  10),   -- INT +10
    (25693,  5,  40),   -- MP +40
...
REPLACE INTO `item_equipment` VALUES
    (26009, "petes_spore_necklace", 31, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (26009,  12,   8),   -- INT +8
    (26009, 28,  10),   -- MATK +10
    (26009, 30,   8);   -- MACC +8
...
REPLACE INTO `item_equipment` VALUES
    (23710, "trevors_myconid_crown", 71, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23710,  1,  20),   -- DEF +20
    (23710,  12,  15),   -- INT +15
    (23710,  5,  60),   -- MP +60
...
REPLACE INTO `item_equipment` VALUES
    (11628, "trevors_decay_ring", 74, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11628,  12,  14),   -- INT +14
    (11628, 28,  18),   -- MATK +18
    (11628,  5,  50),   -- MP +50
...
REPLACE INTO `item_equipment` VALUES
    (23711, "brunos_discount_helm", 8, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23711,  1,   5),   -- DEF +5
    (23711,  8,   3),   -- STR +3
    (23711,  9,   3),   -- DEX +3
...
REPLACE INTO `item_equipment` VALUES
    (28446, "brunos_lucky_pouch", 26, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28446,  9,   5),   -- DEX +5
    (28446, 25,   5),   -- ACC +5
    (28446, 14,   4);   -- CHR +4
...
REPLACE INTO `item_equipment` VALUES
    (25694, "sams_swindler_vest", 46, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25694,  1,  14),   -- DEF +14
    (25694,  9,   8),   -- DEX +8
    (25694,  11,   6),   -- AGI +6
...
REPLACE INTO `item_equipment` VALUES
    (27529, "sams_grift_earring", 55, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (27529,  9,   8),   -- DEX +8
    (27529, 25,  10),   -- ACC +10
    (27529, 384,   4);   -- Haste +4
...
REPLACE INTO `item_equipment` VALUES
    (25695, "steves_glittering_mail", 64, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25695,  1,  22),   -- DEF +22
    (25695,  9,  12),   -- DEX +12
    (25695,  11,  10),   -- AGI +10
...
REPLACE INTO `item_equipment` VALUES
    (11630, "steves_magpie_ring", 73, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11630,  9,  12),   -- DEX +12
    (11630, 25,  15),   -- ACC +15
    (11630, 23,  12),   -- ATT +12
...
REPLACE INTO `item_equipment` VALUES
    (26010, "wilhelminas_fang_necklace", 34, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (26010, 23,  10),   -- ATT +10
    (26010,  8,   7),   -- STR +7
    (26010,  9,   5);   -- DEX +5
...
REPLACE INTO `item_equipment` VALUES
    (23253, "wilhelminas_grace_legs", 58, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23253,  1,  14),   -- DEF +14
    (23253,  11,   8),   -- AGI +8
    (23253, 68,  10),   -- EVA +10
...
REPLACE INTO `item_equipment` VALUES
    (23532, "patricias_claw_gauntlets", 60, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23532,  1,  16),   -- DEF +16
    (23532,  8,  10),   -- STR +10
    (23532, 23,  14),   -- ATT +14
...
REPLACE INTO `item_equipment` VALUES
    (28614, "patricias_predator_cape", 72, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28614,  8,  10),   -- STR +10
    (28614,  11,  10),   -- AGI +10
    (28614, 23,  12),   -- ATT +12
...
REPLACE INTO `item_equipment` VALUES
    (25696, "nigels_feral_cuirass", 64, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25696,  1,  28),   -- DEF +28
    (25696,  8,  14),   -- STR +14
    (25696,  9,  12),   -- DEX +12
...
REPLACE INTO `item_equipment` VALUES
    (11631, "nigels_cateye_ring", 72, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11631,  8,  14),   -- STR +14
    (11631, 23,  20),   -- ATT +20
    (11631, 25,  18),   -- ACC +18
...
REPLACE INTO `item_equipment` VALUES
    (26011, "steves_tiger_fangs", 16, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (26011,  8,   6),   -- STR +6
    (26011, 23,   8),   -- ATT +8
    (26011, 25,   5);   -- ACC +5
...
REPLACE INTO `item_equipment` VALUES
    (28615, "steves_pelt_mantle", 40, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28615,  1,  10),   -- DEF +10
    (28615,  8,   7),   -- STR +7
    (28615,  10,   5),   -- VIT +5
...
REPLACE INTO `item_equipment` VALUES
    (23712, "maurices_savage_helm", 52, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23712,  1,  16),   -- DEF +16
    (23712,  8,  10),   -- STR +10
    (23712, 23,  14),   -- ATT +14
...
REPLACE INTO `item_equipment` VALUES
    (28447, "maurices_mauler_belt", 63, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28447,  8,  10),   -- STR +10
    (28447, 23,  15),   -- ATT +15
    (28447,  9,   8),   -- DEX +8
...
REPLACE INTO `item_equipment` VALUES
    (23265, "sabrinas_feral_legs", 67, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23265,  1,  24),   -- DEF +24
    (23265,  8,  14),   -- STR +14
    (23265,  9,  12),   -- DEX +12
...
REPLACE INTO `item_equipment` VALUES
    (11641, "sabrinas_apex_ring", 64, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11641,  8,  14),   -- STR +14
    (11641, 23,  20),   -- ATT +20
    (11641, 25,  18),   -- ACC +18
...
REPLACE INTO `item_equipment` VALUES
    (27530, "ritas_leaf_earring", 11, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (27530,  13,   3),   -- MND +3
    (27530, 14,   3),   -- CHR +3
    (27530,  5,  10);   -- MP +10
...
REPLACE INTO `item_equipment` VALUES
    (23533, "ritas_petal_wrist", 10, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23533,  1,   3),   -- DEF +3
    (23533,  13,   4),   -- MND +4
    (23533,  5,  15);   -- MP +15
...
REPLACE INTO `item_equipment` VALUES
    (23713, "spencers_verdant_hat", 36, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23713,  1,   8),   -- DEF +8
    (23713,  13,   7),   -- MND +7
    (23713,  5,  30),   -- MP +30
...
REPLACE INTO `item_equipment` VALUES
    (11632, "spencers_bloom_ring", 42, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11632,  13,   7),   -- MND +7
    (11632,  12,   5),   -- INT +5
    (11632, 28,   6);   -- MATK +6
...
REPLACE INTO `item_equipment` VALUES
    (23732, "maxs_shriek_mask", 64, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23732,  1,  16),   -- DEF +16
    (23732,  13,  12),   -- MND +12
    (23732,  12,  10),   -- INT +10
...
REPLACE INTO `item_equipment` VALUES
    (28448, "maxs_earthscream_belt", 59, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28448,  13,  10),   -- MND +10
    (28448,  12,  10),   -- INT +10
    (28448, 28,  12),   -- MATK +12
...
REPLACE INTO `item_equipment` VALUES
    (23259, "claytons_chitin_legs", 13, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23259,  1,   4),   -- DEF +4
    (23259,  10,   4),   -- VIT +4
    (23259,  2,  15);   -- HP +15
...
REPLACE INTO `item_equipment` VALUES
    (11634, "claytons_clack_ring", 14, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11634,  1,   3),   -- DEF +3
    (11634,  10,   4),   -- VIT +4
    (11634,  8,   3);   -- STR +3
...
REPLACE INTO `item_equipment` VALUES
    (23783, "douglass_roller_boots", 31, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23783,  1,  12),   -- DEF +12
    (23783,  10,   8),   -- VIT +8
    (23783,  8,   6),   -- STR +6
...
REPLACE INTO `item_equipment` VALUES
    (26012, "douglass_carapace_necklace", 19, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (26012,  10,   8),   -- VIT +8
    (26012,  1,   8),   -- DEF +8
    (26012, 29,   6);   -- MDEF +6
...
REPLACE INTO `item_equipment` VALUES
    (23738, "sebastians_sacred_helm", 65, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23738,  1,  22),   -- DEF +22
    (23738,  10,  12),   -- VIT +12
    (23738,  8,  10),   -- STR +10
...
REPLACE INTO `item_equipment` VALUES
    (11635, "sebastians_jeweled_ring", 64, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11635,  10,  12),   -- VIT +12
    (11635,  1,  12),   -- DEF +12
    (11635,  2,  70),   -- HP +70
...
REPLACE INTO `item_equipment` VALUES
    (23534, "simons_silk_gloves", 14, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23534,  1,   5),   -- DEF +5
    (23534,  9,   5),   -- DEX +5
    (23534, 25,   5);   -- ACC +5
...
REPLACE INTO `item_equipment` VALUES
    (28616, "simons_webbed_cape", 11, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28616,  1,   6),   -- DEF +6
    (28616,  11,   5),   -- AGI +5
    (28616, 68,   6);   -- EVA +6
...
REPLACE INTO `item_equipment` VALUES
    (25697, "carls_chrysalis_mail", 65, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25697,  1,  25),   -- DEF +25
    (25697,  10,  12),   -- VIT +12
    (25697,  2,  70),   -- HP +70
...
REPLACE INTO `item_equipment` VALUES
    (14646, "carls_metamorph_ring", 64, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (14646,  2,  80),   -- HP +80
    (14646,  5,  40),   -- MP +40
    (14646,  10,  12),   -- VIT +12
...
REPLACE INTO `item_equipment` VALUES
    (25698, "freds_down_vest", 11, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25698,  1,   5),   -- DEF +5
    (25698,  11,   4),   -- AGI +4
    (25698, 68,   4);   -- EVA +4
...
REPLACE INTO `item_equipment` VALUES
    (15549, "freds_talon_ring", 11, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (15549,  11,   4),   -- AGI +4
    (15549,  9,   3),   -- DEX +3
    (15549, 25,   4);   -- ACC +4
...
REPLACE INTO `item_equipment` VALUES
    (23739, "beatrices_plume_hat", 40, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23739,  1,  10),   -- DEF +10
    (23739,  11,   8),   -- AGI +8
    (23739, 68,  10),   -- EVA +10
...
REPLACE INTO `item_equipment` VALUES
    (27531, "beatrices_wind_earring", 48, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (27531,  11,   8),   -- AGI +8
    (27531, 68,  12),   -- EVA +12
    (27531, 384,   3);   -- Haste +3
...
REPLACE INTO `item_equipment` VALUES
    (25699, "patricias_zephyr_vest", 71, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25699,  1,  20),   -- DEF +20
    (25699,  11,  14),   -- AGI +14
    (25699, 68,  18),   -- EVA +18
...
REPLACE INTO `item_equipment` VALUES
    (15550, "patricias_gale_ring", 70, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (15550,  11,  14),   -- AGI +14
    (15550, 68,  20),   -- EVA +20
    (15550, 384,   6);   -- Haste +6
...
REPLACE INTO `item_equipment` VALUES
    (27532, "harolds_honey_earring", 7, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (27532, 14,   5),   -- CHR +5
    (27532,  13,   3),   -- MND +3
    (27532,  2,  15);   -- HP +15
...
REPLACE INTO `item_equipment` VALUES
    (15780, "harolds_stinger_ring", 11, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (15780,  9,   4),   -- DEX +4
    (15780, 23,   4),   -- ATT +4
    (15780,  8,   3);   -- STR +3
...
REPLACE INTO `item_equipment` VALUES
    (23535, "barrys_venom_gauntlets", 56, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23535,  1,  12),   -- DEF +12
    (23535,  9,   8),   -- DEX +8
    (23535, 23,  10),   -- ATT +10
...
REPLACE INTO `item_equipment` VALUES
    (26013, "barrys_swarm_necklace", 37, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (26013,  8,   8),   -- STR +8
    (26013, 23,  12),   -- ATT +12
    (26013, 25,   8);   -- ACC +8
...
REPLACE INTO `item_equipment` VALUES
    (23740, "quentins_royal_crown", 69, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23740,  1,  25),   -- DEF +25
    (23740,  2,  80),   -- HP +80
    (23740,  5,  40),   -- MP +40
...
REPLACE INTO `item_equipment` VALUES
    (15781, "quentins_hivemind_ring", 68, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (15781,  12,  14),   -- INT +14
    (15781,  13,  14),   -- MND +14
    (15781, 28,  18),   -- MATK +18
...
REPLACE INTO `item_equipment` VALUES
    (15794, "winstons_dirt_ring", 6, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (15794,  10,   2),   -- VIT +2
    (15794,  2,  10);   -- HP +10
...
REPLACE INTO `item_equipment` VALUES
    (28449, "winstons_earthen_belt", 5, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28449,  10,   3),   -- VIT +3
    (28449,  8,   2);   -- STR +2
...
REPLACE INTO `item_equipment` VALUES
    (23755, "shermans_subterran_helm", 23, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23755,  1,   7),   -- DEF +7
    (23755,  10,   5),   -- VIT +5
    (23755,  2,  25),   -- HP +25
...
REPLACE INTO `item_equipment` VALUES
    (27533, "shermans_tunnel_earring", 23, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (27533,  10,   6),   -- VIT +6
    (27533,  8,   5),   -- STR +5
    (27533, 23,   6);   -- ATT +6
...
REPLACE INTO `item_equipment` VALUES
    (25689, "ernests_burrower_vest", 53, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25689,  1,  17),   -- DEF +17
    (25689,  10,  10),   -- VIT +10
    (25689,  8,   8),   -- STR +8
...
REPLACE INTO `item_equipment` VALUES
    (23750, "ernests_tremor_boots", 53, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (23750,  1,  14),   -- DEF +14
    (23750,  10,   8),   -- VIT +8
    (23750,  2,  40),   -- HP +40
...
REPLACE INTO `item_equipment` VALUES
    (11642, "sallys_scale_ring", 12, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11642,  9,   4),   -- DEX +4
    (11642,  11,   3),   -- AGI +3
    (11642, 68,   4);   -- EVA +4
...
REPLACE INTO `item_equipment` VALUES
    (28440, "sallys_tail_belt", 14, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (28440,  8,   3),   -- STR +3
    (28440,  9,   3),   -- DEX +3
    (28440,  2,  10);   -- HP +10
...
REPLACE INTO `item_equipment` VALUES
    (25690, "carloss_reptile_vest", 41, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25690,  1,  13),   -- DEF +13
    (25690,  8,   7),   -- STR +7
    (25690,  10,   7),   -- VIT +7
...
REPLACE INTO `item_equipment` VALUES
    (26118, "carloss_venom_earring", 44, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (26118,  9,   7),   -- DEX +7
    (26118,  11,   6),   -- AGI +6
    (26118, 23,   8);   -- ATT +8
...
REPLACE INTO `item_equipment` VALUES
    (25691, "boriss_granite_carapace", 62, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (25691,  1,  25),   -- DEF +25
    (25691,  10,  14),   -- VIT +14
    (25691,  8,  12),   -- STR +12
...
REPLACE INTO `item_equipment` VALUES
    (11643, "boriss_stone_gaze_ring", 62, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
REPLACE INTO `item_mods` VALUES
    (11643,  8,  12),   -- STR +12
    (11643,  10,  12),   -- VIT +12
    (11643,  1,  14),   -- DEF +14
...
REPLACE INTO `item_equipment` VALUES (23757, "WnfrdWCap", 26, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23536, "WnfrdWMit", 27, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23786, "BtrceSShoe", 27, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23260, "BtrceHHkm", 28, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23537, "ClydeCGnt", 27, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28450, "ClydePBlt", 21, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23787, "SrphnSBts", 17, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (15798, "SrphnRRng", 39, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27536, "CrdelaEar", 39, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28619, "CrdelasMnt", 40, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28618, "FrdrcaClk", 40, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23261, "FrdrcaHse", 34, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23758, "MllcntHbd", 63, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23538, "MllcntGGl", 21, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25700, "BrndnABpl", 38, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23788, "BrndnIGrv", 36, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28599, "GrtrdGMnt", 41, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23706, "GrtrdWShs", 44, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23759, "VlntnHHpn", 25, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (15797, "VlntnVRng", 61, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (24076, "DdrBrwBts", 28, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28451, "DdrMdsBlt", 22, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23252, "VncznSCss", 40, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11665, "VncznTRng", 38, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23511, "GdnSArmb", 8, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28430, "GdnGBlt", 12, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23418, "SvnWCHlm", 29, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28604, "SvnBtlMnt", 25, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25701, "RgnldWHbk", 37, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (24077, "RgnldCGrv", 39, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25702, "OphlDPlt", 60, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (14631, "OphlCRng", 37, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (24075, "FnwkISndl", 13, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28429, "FnwkNSsh", 12, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26014, "DllhCCll", 64, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27537, "DllhSEar", 56, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23895, "HrtZMtre", 62, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (14641, "HrtFthRng", 58, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25703, "DmdaARbe", 70, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23797, "DmdaHHbd", 70, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23544, "CrnlsSShr", 9, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23785, "CrnlsAnkl", 11, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26015, "SlvstGCll", 12, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23728, "BaslFGrv", 37, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (14639, "BaslRRng", 28, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25705, "DsmndIHbk", 55, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23896, "DsmndWVsr", 46, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27538, "FnaWngEar", 15, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23707, "FnaNgtSnd", 10, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27539, "EdgrEEar", 27, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23543, "EdgrShMtt", 24, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23761, "VlrnNtCwl", 28, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (14637, "VlrnVRng", 24, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28620, "ArmntDMnt", 31, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23708, "ArmntHAnk", 36, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23729, "SlsSnkSnd", 13, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28438, "SlsColSsh", 5, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25538, "HlseCCll", 59, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27535, "HlseLEar", 12, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23541, "CrsdSqGlv", 32, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28435, "CrsdBBlt", 24, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23415, "VvneTxTar", 51, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (14645, "VvneSrpRng", 66, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26003, "BrnbsWBrc", 13, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23709, "BrnbsBBts", 13, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25706, "DrthaCV", 29, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (14633, "DrthaHRng", 26, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23417, "PrcvlPMsk", 28, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28617, "PrcvlBMnt", 24, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23416, "SphnHMHlm", 70, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23264, "SphnDTsst", 44, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23542, "NthnlRArmb", 7, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23726, "NthnlGSnd", 5, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (14635, "FrncsRng", 48, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23979, "HrtnMwGrd", 44, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23540, "HrtnGGnt", 37, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23980, "CrnlsDShr", 71, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11640, "CrnlsGRng", 57, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26107, "RdrckBEar", 16, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23727, "RdrckRGrv", 14, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25537, "CvndshHCl", 60, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26105, "CvndshEar", 17, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23736, "BndctDBts", 26, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28434, "BndctUBlt", 5, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23977, "LntNRobe", 67, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (14643, "LntSDRng", 42, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23510, "SmeonWrst", 11, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26106, "SmeonSEar", 5, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28598, "VsprTxMnt", 25, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28433, "VsprCBlt", 5, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23263, "PtlmyACss", 33, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (15857, "PtlmyERng", 30, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25682, "DgnyRCrp", 50, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26116, "DgnyFEar", 53, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (15856, "WndyWRng", 14, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27928, "StnslasMtt", 21, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25683, "ElnrArVst", 31, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28432, "ElnrSWBlt", 11, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23435, "GwndlnSTar", 46, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28597, "GwndlnSMnt", 49, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11062, "OswldSRng", 21, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28208, "OswldSlSnd", 15, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26001, "BrghldVCl", 52, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26108, "BrghldAEar", 14, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27937, "CllstDMtt", 29, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27564, "CllstCRng", 18, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25680, "PrtsaPRbe", 68, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27574, "PrtsaShRng", 36, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26115, "SlvtrGEar", 14, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23661, "SlvtrWBts", 9, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28431, "SclllyRBlt", 6, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25681, "ScllySMl", 30, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28609, "TbrsaCMnt", 21, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28575, "TbrsaRRng", 29, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23434, "DlcxMHlm", 35, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27568, "DlcxAbRng", 36, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25545, "LrttaPNGd", 10, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23684, "LrttaSBts", 13, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28606, "ThadsMnt", 18, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26349, "ThdsaTBlt", 20, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23262, "CrsntaICss", 33, 0, 4194303, 0, 0, 0, 1024, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28550, "CrsntaCRng", 33, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23983, "PrcvlBPlt", 55, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25544, "PrcvlTCll", 44, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23512, "ClmnsBAGd", 21, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10789, "ClmnsStRng", 9, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23419, "BrthlmBHlm", 25, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26345, "BrthlmSBlt", 26, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23981, "CnrdMHbk", 55, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23685, "CnrdESBts", 33, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23982, "ThbldCPlt", 67, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28547, "ThbldWRng", 47, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28534, "MrtmrBkRng", 41, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23686, "MrtmrRSnd", 25, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28523, "AldrHEar", 46, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26000, "AldrGCll", 58, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28608, "ElsptGMnt", 74, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28542, "ElsptNRng", 63, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25687, "WhlmnaARbe", 70, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28564, "WhlmnaCRng", 65, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26082, "MrclnPEar", 14, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10786, "MrclnTRng", 10, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23420, "TmprJHat", 28, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26000, "TmprCCll", 58, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25684, "HrnmsSRbe", 74, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28553, "HrnmsIRng", 33, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28607, "GrgrCMnt", 48, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28579, "GrgrMRng", 33, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28549, "TrtgaLRng", 43, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23687, "TrtgaGBts", 12, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26006, "SbstnCCll", 34, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25685, "SbstnGApn", 52, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11059, "GlnaKRng", 42, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25686, "LstTnFRbe", 75, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10785, "LstTnLRng", 55, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23688, "RccoRBts", 12, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26083, "RccoAEar", 8, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26005, "ThslyCCll", 28, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28601, "ThslyRMnt", 26, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23421, "BldsrLHlm", 41, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10783, "BldsrDRng", 38, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25688, "DsdraARbe", 61, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10787, "DsdraTRng", 43, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26089, "PrsphnEar", 23, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28217, "PrsphnGShs", 17, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11007, "ThrnStMnt", 44, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10791, "ThrnGRng", 26, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23423, "SbstAHlm", 38, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28436, "SbstWBlt", 39, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23984, "HrnymCPlt", 48, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10792, "HrnymARng", 32, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26099, "FrntnDEar", 8, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10794, "FrntnTRng", 13, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23424, "SgsmndCHlm", 37, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11000, "SgsmndGMnt", 26, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25704, "TncrCyPlt", 49, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10795, "TncrTRng", 35, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23717, "AndrSSPlt", 60, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10793, "AndrLRng", 46, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10790, "SbstnPRng", 10, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28339, "SbstnSBts", 14, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27620, "PrdnldDMnt", 28, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28410, "PrdnldSBlt", 27, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23425, "SrfnaDCrn", 34, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10761, "SrfnaORng", 33, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10755, "LzrMRng", 51, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28437, "LrcnStBlt", 10, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23697, "LrcnHdBts", 14, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28602, "ThklCMnt", 16, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26004, "ThklBCll", 18, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23422, "GdfrWHlm", 50, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10756, "GdfrGRng", 37, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (27916, "PatTPHbk", 65, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10759, "PatARng", 55, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23698, "SgrdPtSnd", 11, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10763, "SgrdTRng", 14, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26325, "BlncrtSBlt", 6, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10487, "CrscntAHbk", 36, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10758, "CrscntERng", 23, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10479, "AdlbrtTCrp", 46, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10760, "AdlbrtSRng", 34, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10762, "WhlmsWRng", 8, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23699, "WhlmsCBts", 11, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23436, "FrdrkIDHlm", 39, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28594, "FrdrkBMnt", 22, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23950, "VlntnWHbk", 55, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10754, "VlntnFRng", 34, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23951, "AgrppADPlt", 46, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10757, "AgrppDRng", 47, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10750, "WhlmGRng", 44, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23700, "WhlmMBts", 14, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25419, "ClgrACll", 22, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28414, "ClgrGBlt", 12, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23952, "AgtArcHbk", 63, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (10753, "AgtMysRng", 39, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23953, "PtlmPBdy", 65, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11660, "DrvshBRng", 20, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26339, "DrvshDBlt", 9, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28521, "WncslsVEar", 26, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28595, "WncslsAMnt", 21, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23954, "CrnlnHHbk", 58, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11659, "CrnlnPhRng", 36, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23955, "EmrckEPlt", 66, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11657, "EmrckDRng", 60, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26080, "WhlmnaEar", 15, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11658, "WhlmnaSpRng", 39, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25431, "SgsmndBCll", 51, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23514, "SgsmndHMtt", 11, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23956, "PhntsaSRbe", 73, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11661, "PhntsaWRng", 29, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23957, "EphMRobe", 72, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11662, "EphLmtRng", 33, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26100, "BrthlmaEar", 50, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11669, "BrthlmaRng", 10, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25526, "StnslaWCll", 52, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23526, "StnslaAMtt", 21, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23760, "PrclsSVsr", 53, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11674, "PrclsPRng", 63, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23958, "ArbgstSRbe", 52, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11656, "ArbgstORng", 57, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26101, "SvtlnBEar", 6, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23701, "SvtlnSBts", 5, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28596, "CsmraDGMnt", 29, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11663, "CsmraGRng", 14, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23393, "BnvntGHlm", 35, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28467, "BnvntCBlt", 16, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11651, "SrphnusDRng", 33, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11670, "ChchtrCRng", 14, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23702, "ChchtrNBts", 9, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23515, "ThdlndPMtt", 17, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23411, "BlthzrJCrn", 32, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28426, "BlthzrTBlt", 28, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23960, "PlgsJKRbe", 56, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11672, "PlgsAlpRng", 59, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23516, "GldnstrnBrc", 16, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28427, "GldnstrnHBlt", 11, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23412, "PtrnoPHlm", 35, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11671, "PtrnoDRng", 30, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23961, "MlclpsSHbk", 59, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11668, "MlclpsPRng", 41, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23969, "ApllnrsAPlt", 55, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23413, "ApllnrsPCrn", 52, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11667, "TbltShRng", 8, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23703, "TbltPSnd", 14, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25527, "ArchbldFCl", 41, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23704, "ArchbldRBts", 21, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23970, "ElnrACrp", 53, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11647, "ElnrStnRng", 31, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23971, "AlxndrsTF", 72, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11648, "AlxndrsBRng", 53, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26103, "CllrhoeEar", 15, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (28428, "CllrhoeSsh", 59, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25531, "ChrsnthmCCl", 64, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11649, "ChrsnthmLRng", 22, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23972, "SrphmSRbe", 72, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11650, "SrphmTmpRng", 19, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23414, "SphrnaSTar", 74, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11646, "SphrnaSOvRng", 43, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (26104, "BrndCEar", 13, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (15858, "BrndDrRng", 24, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25532, "GrsldaBCll", 27, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23520, "GrsldaGMtt", 10, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23973, "PlcdaMHbk", 39, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11637, "PlcdaSpRng", 21, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23974, "AgstnLDRbe", 55, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11639, "AgstnVtRng", 44, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11644, "LvrnCRng", 32, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23705, "LvrnWBts", 6, 0, 4194303, 0, 0, 0, 2048, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (25533, "SbstynWCll", 56, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23528, "SbstynSMtt", 12, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23975, "MlchrTRbe", 67, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11645, "MlchrERng", 24, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (23976, "MlpmARbe", 62, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (11664, "MlpmCRng", 49, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (228, "crawl_silk_mnt", 53, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (229, "bat_sonar_erng", 38, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (230, "bomb_core_frag", 47, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (231, "rogue_sct_brt", 51, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (232, "tigr_blood_mnt", 61, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (233, "shade_wrth_tab", 74, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (234, "gob_ovst_sach", 63, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (235, "gob_jkpt_bell", 74, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (236, "goob_rootbelt", 69, 0, 4194303, 0, 0, 0, 512, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (237, "drd_hnt_chokr", 64, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (238, "fell_cmd_vamb", 65, 0, 4194303, 0, 0, 0, 32, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (239, "nexus_core_hlm", 67, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (240, "cryst_golm_hrt", 73, 0, 4194303, 0, 0, 0, 4, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (241, "void_wyrm_fang", 68, 0, 4194303, 0, 0, 0, 2, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (242, "abys_typ_diad", 68, 0, 4194303, 0, 0, 0, 1, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (243, "anc_kng_carap", 66, 0, 4194303, 0, 0, 0, 16, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (244, "apex_soulstone", 68, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (245, "wandrers_lgcy", 61, 0, 4194303, 0, 0, 0, 64, 0, 0, 0);
...
REPLACE INTO `item_equipment` VALUES (249, "void_wyrm_scl", 70, 0, 4194303, 0, 0, 0, 256, 0, 0, 0);
